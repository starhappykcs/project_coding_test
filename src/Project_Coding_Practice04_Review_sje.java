...
public class Project_Coding_Practice04_Review_sje {
	...
	public static void main(String[] args) {
		...
		if(A.equalsIgnoreCase("kbs")) {
			System.out.print("KBS는 한국방송공사입니다.");
		} else if(A.equalsIgnoreCase("sbs")){
			System.out.print("SBS는 서울방송입니다.");
		} else {
			System.out.print(A + "는 지정된 영어 문자열이 아닙니다.");
		}
