...
public class Project_Coding_Practice10_while_mdy_Question{
	public static void main(String[] args) {

		// Scanner 클래스를 활용하여 시스템으로부터 입력 받은 값을 변수 in에 담아서
		// scan 객체 참조 변수에 대입해 줍니다.		
		Scanner scan = new Scanner(System.in);
		System.out.print("3의 배수값을 알고 싶은 입력해 주세요 ===> ");
...
//				System.out.print(i); // 3의 배수 출력
	        ...
	        System.out.println("1부터 " + inputNumber + "까지의 숫자 중에서 3의 배수값들의 합 = " + hap);
