...
public class Project_Coding_Practice10_while_mjh_Question{
	public static void main(String[] args) {
		...
		System.out.print("3배수값을 알고 싶은 입력값을 입력해 주세요 ==> ");
		...
		System.out.println("1부터" + inputNum + "까지 숫자 중에서 3의 배수값들의 합 = " + sum);
